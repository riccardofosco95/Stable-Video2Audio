...
def download_id(youtube_id= "---g-f_I2yQ" ,start_time =1):
    ...
    fpath_out = f"/import/c4dm-datasets-ext/DIFF-SFX/AudioSet-Strong/samples_train/{youtube_id}_{start_time}.mp4"
    ...
    # Extract audio
    fpath_out = f"/import/c4dm-datasets-ext/DIFF-SFX/AudioSet-Strong/samples_train/{youtube_id}_{start_time}.mp3"
...
if __name__ == "__main__":
    with open('/homes/rfg543/Documents/Stable-Video2Audio/main/data/audioset_strong/audioset_train_strong.tsv') as f:
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
        ...
        for row in tqdm(dl_list):
            ...
            if not os.path.exists(f"/import/c4dm-datasets-ext/DIFF-SFX/AudioSet-Strong/samples_train/{segment_id}.mp3") and not os.path.exists(f"/import/c4dm-datasets-ext/DIFF-SFX/AudioSet-Strong/samples_train/{segment_id}.mp4"):
                futures.append(executor.submit(download_id, video_id, start_time))
